 ...
 * @date 2021/12/25
 */
public class Medium116PopulatingNextRightPointersInEachNode {
    ...
    public static void main(String[] args) {
        Medium116PopulatingNextRightPointersInEachNode populatingNextRightPointersInEachNode = new Medium116PopulatingNextRightPointersInEachNode();
